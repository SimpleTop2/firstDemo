...
<html>
<head lang="en">
<base href="<%=basepath %>审核/" />
	<meta charset="UTF-8">
	<title>Trading-会员管理-会员审核</title>
             ...
             <div class="member-column">
                ...
                <div class="lib-content">
                    <div class="child-content" style="display: block;">
                        ...
                        <div class="controls">
                            <p>运营者姓名：</p>
                            <div class="basic-name">张三</div>
                        </div>
                         <div class="controls">
                            <p>运营者职务：</p>
                            <div class="basic-name">市场部经理</div>
                        </div>
                        <div class="controls">
                            <p>联系方式：</p>
                            <div class="basic-name">13845678965</div>
                        </div>
                        <div class="controls qt-zj">
                            <p>授权书：</p>
                            <div class="basic-name">
